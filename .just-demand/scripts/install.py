...
def sync_workspace(project_root: Path) -> dict[str, Any]:
    """Sync workspace directory structure with latest layout.
    
    Syncs:
    - scripts/: delete old, copy new
    - state/: create structure, preserve user data (intake/, sessions/)
    - knowledge/: preserve user data (memory.md)
    - Remove legacy directories (global/, workspace/, tasks/)
